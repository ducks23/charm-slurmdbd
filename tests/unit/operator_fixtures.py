...
# -*- coding: utf-8 -*-
# vim:fenc=utf-8
# Copyright © 2020 Jesse jesse@omnivector.solutions
...
import ops
import ops.main
from src.charm import SlurmdbdCharm
...
class OperatorTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        charm = SlurmdbdCharm(framework, None)
        self.charm = charm
    ...
    def get_notice_count(self, hook):
        ...
        notice_count = 0
        handle = "SlurmdbdCharm/on/{}".format(hook)
